...
import { look, flip, map, watch, restart } from './commands.js';
...
class WebServer {
    ...
    public constructor(
        ...
        /*
         * POST /restart/<playerId>
         * playerId must be a nonempty string of alphanumeric or underscore characters
         *
         * Resets the game board to its original configuration.
         *
         * Response is the reset board from the perspective of playerId.
         */
